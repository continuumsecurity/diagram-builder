YUI.add('aui-diagram-node', function (A, NAME) {
    ...
    DiagramNode = A.Component.create({
                                          ...
                                          * @static
                                          */
                                         CIRCLE_POINTS: [[35, 20], [28, 33], [14, 34], [5, 22], [10, 9], [24, 6],
                                             [34, 16], [31, 30], [18, 35], [6, 26], [
                                                 7, 12], [20, 5], [33, 12], [34, 26], [22, 35], [9, 30], [6, 16],
                                             [16, 6], [30, 9], [35, 22], [26, 34], [
                                                 12, 33], [5, 20], [12, 7], [26, 6], [35, 18], [30, 31], [16, 34],
                                             [6, 24], [9, 10], [22, 5], [34, 14], [
                                                 33, 28], [20, 35], [7, 28], [6, 14], [18, 5], [31, 10], [34, 24],
                                             [24, 34], [10, 31], [5, 18], [14, 6], [
                                                 28, 8], [35, 20], [28, 33], [14, 34], [5, 22], [10, 8], [25, 6],
                                             [34, 16], [31, 30], [18, 35], [6, 26], [
                                                 8, 12], [20, 5], [33, 12], [33, 27], [22, 35], [8, 30], [6, 15],
                                             [16, 6], [30, 9], [35, 23], [26, 34], [
                                          ...
                                          * @static
                                          */
                                         DIAMOND_POINTS: [[30, 5], [35, 10], [40, 15], [45, 20], [50, 25], [55, 30],
                                             [50, 35], [45, 40], [40, 45], [35,
                                                                            50], [30, 55], [25, 50], [20, 45], [15, 40],
                                             [10, 35], [5, 30], [10, 25], [15, 20], [20, 15], [25, 10]],
                                          ...
                                          * @static
                                          */
                                         SQUARE_POINTS: [[5, 5], [10, 5], [15, 5], [20, 5], [25, 5], [30, 5], [35, 5],
                                             [40, 5], [50, 5], [55, 5], [60, 5], [
                                                 65, 5], [65, 10], [65, 15], [65, 20], [65, 25], [65, 30], [65, 35],
                                             [65, 40], [65, 45], [65, 50], [65,
                                                                            55], [65, 60], [65, 65], [60, 65], [55, 65],
                                             [50, 65], [45, 65], [40, 65], [35, 65], [30, 65], [25, 65], [
                                                 20, 65], [15, 65], [10, 65], [5, 65], [5, 60], [5, 55], [5, 50],
                                             [5, 45], [5, 40], [5, 35], [5, 30], [5,
                                                                                  25], [5, 20], [5, 15], [5, 10]],
                                         ...
                                         getNodeCoordinates: function (container, node) {
                                             ...
                                             var containerXY = A.Lang.isArray(container) ? container
                                                                                         : container.getXY();
                                         ...
                                         buildNodeId: function (id) {
                                             return 'diagramNode' + '_' + 'field' + '_' + id.replace(/[^a-z0-9.:_\-]/ig,
                                                                                                     '_');
                                         },

                                         prototype: {
                                             LABEL_TEMPLATE: '<div class="' + CSS_DIAGRAM_NODE_LABEL
                                                             + '">{label}</div>',
                                             ...
                                             SERIALIZABLE_ATTRS: ['description', 'name', 'required', 'type', 'width',
                                                                  'height', 'zIndex', 'xy'],
                                             ...
                                             initializer: function () {
                                                 ...
                                                 instance.after({
                                                                    'map:remove': A.bind(instance._afterMapRemove,
                                                                                         instance),
                                                 ...
                                                 instance.boundingBox.addClass(CSS_DIAGRAM_NODE + '-' + instance.get(
                                                     'type'));
                                             ...
                                             alignTransitions: function () {
                                                 ...
                                                 A.Array.each(transitions.values(),
                                                              A.bind(instance.alignTransition, instance));
                                             },
                                             ...
                                             eachConnector: function (fn) {
                                                 ...
                                                 A.Array.each(instance.get('builder').getSourceNodes(instance),
                                                              function (sourceNode) {
                                                                  ...
                                                                  A.Array.each(sourceConnectors.values(),
                                                                               function (connector) {
                                                 ...
                                                 A.Array.each(connectors, function (connector, index) {
                                                     fn.call(instance, connector, index,
                                                             (index < tIndex) ? instance : sourceNodes[index - tIndex]);
                                                 });
                                             ...
                                             getContainer: function () {
                                                 ...
                                                 return (instance.get('builder').dropContainer || instance.get(
                                                     'boundingBox').get('parentNode'));
                                             },
                                             ...
                                             renderShapeInvite: function () {
                                                 ...
                                                 var invite = instance.invite =
                                                     instance.get('builder').get('graphic')
                                                         .addShape(instance.get('shapeInvite'));
                                             ...
                                             _afterRender: function () {
                                                 ...
                                                 instance.setStdModContent(A.WidgetStdMod.BODY, '',
                                             ...
                                             _connectorsValueFn: function () {
                                                 ...
                                                 return new A.Map({
                                                                      after: {
                                                                          remove: A.bind(instance._afterConnectorRemove,
                                                                                         instance)
                                                                      }
                                                                  });
                                             },
                                             ...
                                             _onNameChange: function (event) {
                                                 ...
                                                 instance.eachConnector(function (connector, index, sourceNode) {
                                                     ...
                                                     transition[(instance === sourceNode) ? 'source' : 'target'] =
                                                         event.newVal;
                                             ...
                                             _renderGraphic: function () {
                                                 ...
                                                 instance.renderShapeBoundary()
                                                     .addClass(CSS_DIAGRAM_NODE_SHAPE_BOUNDARY);
                                             ...
                                             _setTransitions: function (val) {
                                                 ...
                                                 if (!isMap(val)) {
                                                     var map = new A.Map({
                                                                             after: {
                                                                                 remove: A.bind(
                                                                                     instance._afterTransitionsRemove,
                                                                                     instance)
                                                                             }
                                                                         });
                                             ...
                                             _setupBoundaryDrag: function () {
                                                 ...
                                                 instance.boundaryDragDelegate = new A.DD.Delegate({
                                                                                                       ...
                                                                                                       nodes: '.'
                                                                                                              + CSS_DIAGRAM_NODE_SHAPE_BOUNDARY,
                                                                                                       dragConfig: {
                                                                                                           useShim: false,
                                                                                                           plugins: [
                                                                                                               {
                                                                                                       ...
                                                                                                       on: {
                                                                                                           'drag:drag': A.bind(
                                                                                                               instance._onBoundaryDrag,
                                                                                                               instance),
                                                                                                           'drag:end': A.bind(
                                                                                                               instance._onBoundaryDragEnd,
                                                                                                               instance),
                                                                                                           'drag:start': A.bind(
                                                                                                               instance._onBoundaryDragStart,
                                                                                                               instance)
                                                                                                       }
                                                                                                   });
                                                 ...
                                                 A.Do.after(instance._bindBoundaryEvents,
                                                            instance.boundaryDragDelegate.dd, '_unprep', instance);
                                             },
                                             ...
                                             _uiSetHighlighted: function (val) {
                                                 ...
                                                 if (instance.get('rendered')) {
                                                     var stroke = val ? instance.get('highlightBoundaryStroke')
                                             ...
                                             _uiSetName: function (val) {
                                                 ...
                                                 boundingBox.setAttribute('data-nodeId', A.Escape.html(
                                                     A.DiagramNode.buildNodeId(val)));
                                             ...
                                             _uiSetSelected: function (val) {
                                                 ...
                                                 instance.get('boundingBox')
                                                     .toggleClass(CSS_DIAGRAM_NODE_SELECTED, val);
                                             ...
                                             _uiSetXY: function (val) {
                                                 ...
                                                 this._posNode.setXY(
                                                     [val[0] + containerXY[0], val[1] + containerXY[1]]);
                                             },
