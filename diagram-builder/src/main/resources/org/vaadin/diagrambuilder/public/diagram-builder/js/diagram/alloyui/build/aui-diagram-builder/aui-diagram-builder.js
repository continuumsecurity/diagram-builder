YUI.add('aui-diagram-builder', function (A, NAME) {
    ...
    var DiagramBuilder = A.Component.create({
                                                ...
                                                ATTRS: {
                                                    ...
                                                    /**
                                                     * Stores an instance of `A.Overlay` used in the connector
                                                     * suggestion.
                                                     *
                                                ...
                                                prototype: {
                                                    ...
                                                    /**
                                                     * Construction logic executed during `A.DiagramBuilder`
                                                    ...
                                                    initializer: function () {
                                                        ...
                                                        A.DiagramNodeManager.on({
                                                                                    publishedSource: function (event) {
                                                                                        ...
                                                                                        instance.publishedSource =
                                                                                            event.publishedSource;
                                                                                    }
                                                                                });

                                                        canvas.on('mousedown',
                                                                  A.bind(instance._onCanvasMouseDown, instance));
                                                        canvas.on('mouseenter',
                                                                  A.bind(instance._onCanvasMouseEnter, instance));

                                                        instance.handlerKeyDown =
                                                            A.getDoc().on('keydown',
                                                                          A.bind(instance._afterKeyEvent, instance));

                                                        instance.dropContainer.delegate(
                                                            'click', A.bind(instance._onNodeClick, instance), '.'
                                                                                                              + CSS_DIAGRAM_NODE);

                                                        instance.dropContainer.delegate(
                                                            'contextmenu', A.bind(instance._onRightClick, instance), '.'
                                                                                                                     + CSS_DIAGRAM_NODE);

                                                        instance.dropContainer.delegate(
                                                            'mousedown',
                                                            A.bind(instance._onCloseButtonMouseDown, instance),
                                                            '.diagram-builder-controls button'
                                                        );

                                                        instance.dropContainer.delegate(
                                                            'mouseenter',
                                                            A.bind(instance._onNodeMouseEnter, instance), '.'
                                                                                                          + CSS_DIAGRAM_NODE);

                                                        instance.dropContainer.delegate(
                                                            'mouseleave',
                                                            A.bind(instance._onNodeMouseLeave, instance), '.'
                                                                                                          + CSS_DIAGRAM_NODE);
                                                    },
                                                    ...
                                                    closeEditProperties: function () {
                                                        ...
                                                        if (editingNode) {
                                                            editingNode.get('boundingBox')
                                                                .removeClass(CSS_DIAGRAM_NODE_EDITING);
                                                        }
                                                    ...
                                                    connectAll: function (nodes) {
                                                        ...
                                                        AArray.each(nodes, function (node) {
                                                            if (node.hasOwnProperty('source') && node.hasOwnProperty(
                                                                'target')) {
                                                    ...
                                                    deleteSelectedConnectors: function () {
                                                        ...
                                                        if (selectedConnectors.length && window.confirm(
                                                            strings.deleteConnectorsMessage)) {
                                                            AArray.each(selectedConnectors, function (connector) {
                                                                var transition = connector.get('transition');

                                                                A.DiagramNode.getNodeByName(transition.source)
                                                    ...
                                                    deleteSelectedNode: function () {
                                                        ...
                                                        if (selectedNode && !selectedNode.get('required')
                                                            && window.confirm(strings.deleteNodesMessage)) {
                                                            selectedNode.close();
                                                            instance.editingNode = instance.selectedNode = null;
                                                            instance.stopEditing();
                                                        }
                                                    ...
                                                    /**
                                                     * Destructor lifecycle implementation for the `A.DiagramBuilder`
                                                     * class.
                                                     *
                                                     * @method destructor
                                                     * @param attribute
                                                    ...
                                                    eachConnector: function (fn) {
                                                        ...
                                                        instance.get('fields').each(function (diagramNode) {
                                                            ...
                                                            AArray.each(transitions.values(), function (transition) {
                                                                fn.call(instance, diagramNode.getConnector(transition),
                                                                        transition, diagramNode);
                                                            });
                                                        });
                                                    },
                                                     ...
                                                     * property list, and stores the connector in the
                                                     * `editingConnector` and
                                                    ...
                                                    editConnector: function (connector) {
                                                        ...
                                                        if (connector) {
                                                            ...
                                                            instance.propertyList.set('data',
                                                                                      connector.getProperties());

                                                            instance.editingConnector =
                                                                instance.selectedConnector = connector;
                                                        }
                                                    },

                                                    /**
                                                     * Enables the settings tab, sets the node properties in the
                                                     * property list, and stores the node in the `editingNode` and
                                                    ...
                                                    editNode: function (diagramNode) {
                                                        ...
                                                        if (diagramNode) {
                                                            ...
                                                            instance.propertyList.set('data',
                                                                                      diagramNode.getProperties());

                                                            diagramNode.get('boundingBox')
                                                                .addClass(CSS_DIAGRAM_NODE_EDITING);
                                                    ...
                                                    /**
                                                     * Gets the field class based on the `A.DiagramBuilder` type. If
                                                     * the type doesn't exist, logs an error message.
                                                     *
                                                    ...
                                                    getSourceNodes: function (diagramNode) {
                                                        ...
                                                        return instance.getNodesByTransitionProperty('target',
                                                                                                     diagramNode.get(
                                                                                                         'name'));
                                                    },
                                                    ...
                                                    select: function (diagramNode) {
                                                        ...
                                                        instance.selectedNode =
                                                            diagramNode.set('selected', true).focus();
                                                    },

                                                    /**
                                                     * Shows the suggest connector overlay in a certain X and Y
                                                     * position.
                                                     *
                                                    ...
                                                    showSuggestConnectorOverlay: function (xy) {
                                                        var instance = this,
                                                            showSuggestConnectorOverlay = instance.get(
                                                                'suggestConnectorOverlay');

                                                        showSuggestConnectorOverlay.get('boundingBox')
                                                            .addClass(CSS_DIAGRAM_SUGGEST_CONNECTOR);
                                                    ...
                                                    toJSON: function () {
                                                        ...
                                                        instance.get('fields').each(function (diagramNode) {
                                                            ...
                                                            AArray.each(diagramNode.SERIALIZABLE_ATTRS,
                                                                        function (attributeName) {
                                                                            node[attributeName] =
                                                                                diagramNode.get(attributeName);
                                                                        });
                                                    ...
                                                    unselectConnectors: function () {
                                                        ...
                                                        AArray.each(instance.getSelectedConnectors(),
                                                                    function (connector) {
                                                    ...
                                                    _afterKeyEvent: function (event) {
                                                        ...
                                                        if (event.hasModifier() || A.getDoc().get('activeElement')
                                                            .test(':input,td')) {
                                                            return;
                                                        }

                                                        var isDeleteByKeyStrokeEnable = (instance._getAttr(
                                                            'enableDeleteByKeyStroke') === true);

                                                        if (event.isKey('esc')) {
                                                            instance._onEscKey(event);
                                                        } else if (isDeleteByKeyStrokeEnable && (event.isKey(
                                                            'backspace') || event.isKey('delete'))) {
                                                            instance._onDeleteKey(event);
                                                        }
                                                    },

                                                    /**
                                                     * Deletes the Selected `diagramNode` and any connectors attached
                                                     * to it.
                                                     *
                                                    ...
                                                    _onCloseButtonMouseDown: function (event) {
                                                        ...
                                                        var diagramNode = event.currentTarget.ancestor('.'
                                                                                                       + 'diagram-node');
                                                    ...
                                                    _onDrag: function (event) {
                                                        ...
                                                        if (instance.isFieldsDrag(drag)) {
                                                            ...
                                                            if (diagramNode) {
                                                                ...
                                                                AArray.each(instance.getSourceNodes(diagramNode),
                                                                            function (sourceNode) {
                                                    ...
                                                    _onDropHit: function (event) {
                                                        ...
                                                        if (instance.isAvailableFieldsDrag(drag)) {
                                                            var availableField = drag.get('node')
                                                                .getData('availableField');

                                                            var newField = instance.addField({
                                                                                                 xy: A.DiagramNode.getNodeCoordinates(
                                                                                                     drag.lastXY,
                                                                                                     instance.dropContainer),
                                                                                                 type: availableField.get(
                                                                                                     'type')
                                                                                             });
                                                    ...
                                                    correctPosition: function (attrs) {
                                                        // Return clientX and clientY relative to the drop Container
                                                        // instead of return global clientX clientY that are relative
                                                    ...
                                                    _onNodeEdit: function (event) {
                                                        ...
                                                        // Only enable editing if the double clicked node is inside the
                                                        // node contentBox.
                                                        if (!event.target.ancestor('.' + CSS_DIAGRAM_NODE_CONTENT,
                                                            true)) {
                                                            return;
                                                        }
                                                    ...
                                                    _onNodeMouseLeave: function (event) {
                                                        ...
                                                        if (!publishedSource
                                                            || !publishedSource.boundaryDragDelegate.dd.get(
                                                                'dragging')) {
                                                    ...
                                                    _onSave: function () {
                                                        ...
                                                        if (editingNode) {
                                                            modelList.each(function (model) {
                                                                editingNode.set(model.get('attributeName'),
                                                                                model.get('value'));
                                                            });
                                                        }
                                                        else if (editingConnector) {
                                                            modelList.each(function (model) {
                                                                editingConnector.set(model.get('attributeName'),
                                                                                     model.get('value'));
                                                            });
                                                        }
                                                    },
                                                    ...
                                                    _onSuggestConnectorNodeClick: function (event) {
                                                        var instance = this;
                                                        var availableField = event.currentTarget.getData(
                                                            'availableField');
                                                    ...
                                                    _setSuggestConnectorOverlay: function (val) {
                                                        ...
                                                        if (!val) {
                                                            ...
                                                            AArray.each(instance.get('availableFields'),
                                                                        function (field) {
                                                                            var node = field.get('node');

                                                                            docFrag.appendChild(
                                                                                node.clone().setData('availableField',
                                                                                                     node.getData(
                                                                                                         'availableField'))
                                                                            );
                                                                        });
                                                            ...
                                                            boundingBox.delegate('click', A.bind(
                                                                instance._onSuggestConnectorNodeClick, instance), '.' +
                                                    ...
                                                    /**
                                                     * Creates a new instance of `A.DD.Delegate` in `fieldsDrag`
                                                     * attribute.
                                                     *
                                                    ...
                                                    _moveChildrenGroupNodes: function (diagramNode, instance) {
                                                        if (diagramNode._getAttr('children')) {
                                                            var children = diagramNode._getAttr('children').map(
                                                                function (mapItem) {
                                                                    return instance._getAttr('fields')
                                                                        .filter(function (it) {
                                                            ...
                                                            AArray.each(children, function (child) {
                                                                child._setAttr("x", child._getAttr("x")
                                                                                    + (diagramNode.getNodeCoordinates()[0]
                                                                                       - diagramNode.get(
                                                                            'x')));
                                                                child._setAttr("y", child._getAttr("y")
                                                                                    + (diagramNode.getNodeCoordinates()[1]
                                                                                       - diagramNode.get(
                                                                            'y')));

                                                                child.alignTransitions();

                                                                AArray.each(instance.getSourceNodes(child),
                                                                            function (sourceNode) {
                                                                                sourceNode.alignTransitions();
                                                                            });
                                                            });
                                                    ...
                                                    /**
                                                     * Update the parent group node boundary to the current task
                                                     * children. A task couldn't move outside of parent group
                                                     *
                                                    ...
                                                    _updateTaskNodeBoundary: function (diagramNode, instance) {
                                                        if (diagramNode.get('type') === 'task') {
                                                            instance.get('fields').each(function (node) {
                                                                if (node.get('type') === 'group' && node.get(
                                                                    'children')) {
                                                                    if (node.get('children')
                                                                        .includes(diagramNode.get('name'))) {

                                                                        var leftGroupBoundary = node.get('x');
                                                                        var topGroupBoundary = node.get('y');
                                                                        var rightGroupBoundary = node.get('x')
                                                                                                 + node.get('width');
                                                                        var bottomGroupBoundary = node.get('y')
                                                                                                  + node.get('height');

                                                                        var leftNodeBoundary = diagramNode.get('x');
                                                                        var topNodeBoundary = diagramNode.get('y');
                                                                        var rightNodeBoundary = diagramNode.get('x')
                                                                                                + diagramNode.get(
                                                                                'width');
                                                                        var bottomNodeBoundary = diagramNode.get('y')
                                                                                                 + diagramNode.get(
                                                                                'height');
                                                                        ...
                                                                        if (leftNodeBoundary < leftGroupBoundary) {
                                                                            drag.con._regionCache['left'] =
                                                                                offsetX + leftGroupBoundary;
                                                                        } else if (topNodeBoundary < topGroupBoundary) {
                                                                            drag.con._regionCache['top'] =
                                                                                offsetY + topGroupBoundary;
                                                                        } else if (rightNodeBoundary
                                                                                   > rightGroupBoundary) {
                                                                            drag.con._regionCache['right'] =
                                                                                offsetX + rightGroupBoundary;
                                                                        } else if (bottomNodeBoundary
                                                                                   > bottomGroupBoundary) {
                                                                            drag.con._regionCache['bottom'] =
                                                                                offsetY + bottomGroupBoundary;
                                                                        }
                                                                    }
                                                                }
                                                            });
